...
export class Constants {
	...
	public readonly ROUTES: Record<string, string> = {
		...
		FORGOT_PASSWORD: this.ROUTES_PATHS.FORGOT_PASSWORD,
		...
		_FORGOT_PASSWORD: `/${this.ROUTES_PATHS.FORGOT_PASSWORD}`,
	...
	public readonly snapshots: { imageSrc: string; itemLink?: string }[] = [
		...
		},
		{
			...
			itemLink: 'https://www.postman.com/wasit-shafi-wani/dev-tools-studio/overview',
		},
		{
